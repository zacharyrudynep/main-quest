...
const ATS_STUDIOS = {
  ...
  "Insomniac Games":          { platform:"greenhouse", slug:"insomniacgames" },
  "Respawn Entertainment":    { platform:"greenhouse", slug:"respawn" },
  "Nightdive Studios":        { platform:"greenhouse", slug:"nightdivestudios" },
  "Schell Games":             { platform:"greenhouse", slug:"schellgames" },
  "Jackbox Games":            { platform:"greenhouse", slug:"jackboxgames" },
  "Probably Monsters":        { platform:"greenhouse", slug:"probablymonsters" },
  "Klei Entertainment":       { platform:"greenhouse", slug:"klei" },
  "Second Dinner":            { platform:"greenhouse", slug:"seconddinner" },
  "Frost Giant Studios":      { platform:"greenhouse", slug:"frostgiantstudios" },
  "Deck Nine Games":          { platform:"greenhouse", slug:"decknine" },
  "Hi-Rez Studios":           { platform:"greenhouse", slug:"hirezstudios" },
  "Iron Galaxy Studios":      { platform:"greenhouse", slug:"irongalaxystudios" },
  "Digital Extremes":         { platform:"greenhouse", slug:"digitalextremes" },
  "Behaviour Interactive":    { platform:"greenhouse", slug:"behaviourinteractive" },
  "Cat Daddy Games":          { platform:"greenhouse", slug:"catdaddy" },
  "Velan Studios":            { platform:"greenhouse", slug:"velanstudios" },
  "Harmonix":                 { platform:"greenhouse", slug:"harmonix" },
  "Dreamhaven":               { platform:"greenhouse", slug:"dreamhaven" },
  "Hardsuit Labs":            { platform:"greenhouse", slug:"hardsuitlabs" },
  "Singularity 6":            { platform:"greenhouse", slug:"singularity6" },
  // ─── Lever studios ───
  "Supergiant Games":         { platform:"lever", slug:"supergiant" },
  "Skydance":                 { platform:"lever", slug:"skydance" },
  "Mainframe Industries":     { platform:"lever", slug:"mainframe" },
  // ─── Ashby studios (includes salary data) ───
  "Mistwalker":               { platform:"ashby", slug:"mistwalker" },
...
export default function App() {
  ...
  const getDisplayJobs=(name,gen)=>{
    ...
    const hasLiveSource=!!ATS_STUDIOS[name];
    if(live===undefined){
      // Still loading — return empty if we have a live source, generated if we don't
      return hasLiveSource?[]:gen;
    }
    if(live===null||live.length===0) return []; // confirmed no live jobs
    return live; // real live data
  };
